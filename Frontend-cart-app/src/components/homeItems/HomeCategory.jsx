    ...
    <div className="categories-container">
      <Link to="/products/electronics" className="link">
        <div className="card-info">
          <img
            src="https://res.cloudinary.com/dx7zsxo2g/image/upload/v1683522149/electronics_yjk1bl.webp"
            alt="/"
            className="w-75"
          />
      ...
      <Link to="/products/women" className="link">
        <div className="card-info">
          <img
            src="https://res.cloudinary.com/dx7zsxo2g/image/upload/v1683561941/kurtaset1_suhzrp.png"
            alt="/"
            className="w-100"
          />
      ...
      <Link to="/products/jewelery" className="link">
        <div className="card-info">
          <img
            src="https://res.cloudinary.com/dx7zsxo2g/image/upload/v1683538795/jewellery_axx0pv.png"
            alt="/"
            className="w-75"
          />
